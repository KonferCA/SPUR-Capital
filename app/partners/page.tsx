    ...
    const partnershipTypes = [
        {
            ...
            description:
                'Align with us on shared goals, co-develop technologies, and engage in thought leadership across industries.',
        },
        {
            id: 'technology',
            ...
            description:
                'Collaborate with us to build, integrate, and scale innovative technologies across our platform.',
        },
        {
            id: 'investment',
            ...
            description:
                'Join us to invest in and support promising startups on the SPUR platform. Benefit from early access to disruptive ideas and technologies.',
        },
        {
            id: 'corporate',
            ...
            description:
                'Support events, competitions, and incubation programs that attract top talent and cutting-edge projects.',
        },
    ];
    ...
    const benefits = [
        {
            ...
            description:
                "SPURIC focuses on leveraging the most cutting edge technology for AI, quantum computing, and high-performance computing. Our state-of-the-art infrastructure empowers you to push the boundaries of what's possible.",
        ...
        },
        {
            ...
            description:
                'At SPURIC, we believe that collaboration is the key to breakthroughs. Work alongside experts, startups, and established organizations to accelerate innovation.',
        ...
        },
        {
            ...
            description:
                'Through our unique cooperative model, our partner, Direct Global Data Center Division, provides cost-effective and scalable AI compute solutions to support your projects.',
        ...
        },
        {
            ...
            description:
                'We offer an integrated platform for decentralized funding via DAIT.IO and SPUR blockchain, allowing startups to raise capital through a secure and transparent model.',
            categories: ['all', 'investment', 'strategic'],
        },
        {
            id: 'talent',
            icon: (
                <BriefcaseBusiness className="h-10 w-10 text-branding-orange" />
            ),
            title: 'Access to Talent and Expertise',
            description:
                'Tap into our network of skilled professionals and cutting-edge researchers who can assist in developing and implementing groundbreaking solutions.',
            categories: ['all', 'strategic', 'technology', 'corporate'],
        },
        {
            id: 'network',
            ...
            description:
                'Connect with a diverse ecosystem of innovators, industry leaders, and potential clients to expand your reach and impact.',
    ...
    const steps = [
        {
            ...
            description:
                'Share your vision with us by filling out our partnership application form or emailing us at partners@spuric.com.',
        },
        {
            number: '02',
            title: 'Meet with Our Team',
            description:
                'After reviewing your proposal, our team will schedule a meeting to explore partnership opportunities and discuss how we can collaborate.',
        },
        {
            number: '03',
            title: 'Collaborate and Innovate',
            description:
                "Once we establish a partnership, you'll gain access to our facilities, resources, and a network of innovators committed to making a difference.",
        },
    ];
    ...
    const audienceGroups = [
        {
            ...
            description:
                'Access resources, mentorship and funding opportunities to accelerate your growth',
        },
        {
            name: 'Established Businesses',
            icon: <Building className="h-10 w-10 text-branding-orange" />,
            description:
                'Drive innovation initiatives and digital transformation through our collaborative ecosystem',
        },
        {
            name: 'Academic Institutions',
            icon: <GraduationCap className="h-10 w-10 text-branding-orange" />,
            description:
                'Bridge the gap between theoretical research and practical applications through real-world collaborations',
        },
    ];
                ...
                <div className="container mx-auto px-4">
                    <div className="max-w-4xl mx-auto text-center space-y-6">
                        ...
                        <p className="text-branding-white/80 text-xl sm:text-2xl">
                            Join our ecosystem of innovators shaping the future
                            of technology through collaboration, resources, and
                ...
                <div className="container mx-auto px-4">
                    <div className="text-center space-y-6 mb-16">
                        ...
                        <p className="mx-auto max-w-[800px] text-branding-white/80 text-xl sm:text-2xl">
                            Flexible partnership models tailored to meet your
                            business needs
                        </p>
                    </div>
                            ...
                            >
                                <CardContent className="p-6">
                                    <div className="flex flex-col items-center text-center">
                                        <div
                                            className={`p-3 rounded-lg border mb-4 ${activeTab === type.id ? 'bg-branding-orange/20 border-branding-orange/30' : 'bg-branding-orange/10 border-branding-orange/20'}`}
                                        >
                                            {type.icon}
                                        </div>

                                        <h3 className="text-branding-white font-bold text-xl mb-3">
                                            {type.name}
                                        </h3>
            ...
            >
                <div className="container mx-auto px-4">
                    <div className="text-center space-y-6 mb-12">
                        ...
                        <p className="mx-auto max-w-[800px] text-branding-white/80 text-xl sm:text-2xl">
                            SPURIC is not just an innovation hub - we are a
                            gateway to a collaborative ecosystem designed for
                            tomorrow's leaders
                        </p>
                    </div>
                            ...
                            >
                                <CardContent className="p-8 h-full">
                                    <div className="flex flex-col h-full">
                                        ...
                                        <h3 className="text-xl font-bold text-branding-white mb-3">
                                            {benefit.title}
                                        </h3>
                                ...
                                <CardContent className="p-8">
                                    <div className="flex flex-col items-center text-center">
                                        <div className="w-16 h-16 rounded-full bg-branding-orange/10 border border-branding-orange/20 flex items-center justify-center mb-6">
                                            <span className="text-2xl font-bold text-branding-orange">
                                                {step.number}
                                            </span>
                                        </div>

                                        <h3 className="text-xl font-bold text-branding-white mb-4">
                                            {step.title}
                                        </h3>
            ...
            <section className="py-24 border-t border-branding-white/10 bg-gradient-to-b from-background to-background/90">
                <div className="container mx-auto px-4">
                    <div className="text-center space-y-6 mb-16">
                        ...
                        <p className="mx-auto max-w-[800px] text-branding-white/80 text-xl sm:text-2xl">
                            Whether you're a startup, an established business,
                            or an academic institution, SPURIC offers a dynamic
                    ...
                    <div className="relative w-full max-w-5xl mx-auto p-12 rounded-xl overflow-hidden">
                        ...
                        <div className="relative z-10 text-center space-y-8">
                            ...
                            <p className="text-branding-white/80 text-xl max-w-3xl mx-auto">
                                Together, we can transform industries, build
                                cutting-edge solutions, and pioneer the future
                                of technology.
                            </p>

                            <div className="flex flex-col sm:flex-row gap-4 justify-center pt-4">
                                <Button className="bg-branding-orange hover:bg-branding-orange/90 text-branding-white group text-base sm:text-lg px-4 sm:px-8 py-4 sm:py-6 flex items-center justify-center w-full sm:w-auto">
                                    <a href="mailto:partners@spuric.com">
                                        Connect with Us
                                    </a>
                            ...
                            <div className="pt-6 text-branding-white/60 flex flex-col sm:flex-row items-center justify-center gap-6">
                                <div className="flex items-center gap-2">
                                    ...
                                    <a
                                        ...
                                        className="hover:text-branding-orange transition-colors"
                                    >
                                        www.spuric.com
                                    </a>
                                </div>
