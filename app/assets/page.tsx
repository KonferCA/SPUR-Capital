...
export default function AssetsPage() {
    return (
        <div className="bg-background text-branding-white min-h-screen">
                ...
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center space-y-4 sm:space-y-6 mb-8 sm:mb-12 md:mb-16">
                        ...
                        <p className="mx-auto max-w-[800px] text-branding-white/80 text-lg sm:text-xl md:text-2xl">
                            Four Innovation Centers located in Canada,
                            Four Data Centers at 100% Occupancy
                        </p>
                    </div>
                            ...
                            <CardContent className="p-4 sm:p-6 md:p-8 flex flex-col justify-between h-full">
                                <div>
                                    ...
                                    <p className="text-sm sm:text-base text-branding-white/70">
                                        SPUR Park designed by Blackberry at the height of their market capitalization, sparing no expense. This revolutionary campus offers leading-edge flexible tech lab, industrial space, and Canada's only Tier 4 Data Center.
                                    </p>
                                </div>
                        ...
                        <Card className="bg-background/30 border-branding-white/10 backdrop-blur-sm hover:border-branding-orange/30 transition-colors h-full">
                            <CardContent className="p-4 sm:p-6 md:p-8 flex flex-col justify-between h-full">
                                <div>
                                    ...
                                    <p className="text-sm sm:text-base text-branding-white/70">
                                        Secured Funding through debt financing and internal investment. Target $1B USD minimum allocation by 4th quarter of 2025, with strong investor backing and substantial internal commitment.
                                    </p>
                                </div>
                        ...
                        <Card className="bg-background/30 border-branding-white/10 backdrop-blur-sm hover:border-branding-orange/30 transition-colors h-full lg:col-span-1 md:col-span-2">
                            <CardContent className="p-4 sm:p-6 md:p-8 flex flex-col justify-between h-full">
                                <div>
                                    ...
                                    <p className="text-sm sm:text-base text-branding-white/70">
                                        High Demand Data Center Occupancy for existing facilities. Additional acquisitions are required to support growing client demand, with consistent maximum utilization across all current data center assets.
                                    </p>
                                </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 lg:gap-16 items-center">
                        <div className="space-y-4 sm:space-y-6 md:space-y-8">
                            ...
                            <p className="text-branding-white/80 text-base sm:text-lg md:text-xl">
                                $500 million business park in Waterloo, Ontario, with four operational data centers at 100% capacity. LEED® certified, with rainwater irrigation, low-flow fixtures, and energy-efficient design.
                            </p>
                            ...
                            <div className="space-y-4 sm:space-y-6">
                                <div className="flex items-start gap-3 sm:gap-4">
                                    ...
                                    <div>
                                        <h3 className="text-lg sm:text-xl font-semibold text-branding-white mb-1">Growth Strategy</h3>
                                        <p className="text-sm sm:text-base text-branding-white/70">Acquire commercial properties, convert to cutting edge data centers, and invest in promising tech companies</p>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-start gap-3 sm:gap-4">
                                    ...
                                    <div>
                                        <h3 className="text-lg sm:text-xl font-semibold text-branding-white mb-1">Dual Revenue</h3>
                                        <p className="text-sm sm:text-base text-branding-white/70">Income from real estate leasing and venture capital returns from tech investments</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <Card className="bg-background/30 border-branding-white/10 backdrop-blur-sm hover:border-branding-orange/30 transition-colors overflow-hidden">
                            <CardContent className="p-4 sm:p-5 md:p-6">
                                <div className="flex flex-col items-center text-center">
                                    ...
                                    <h3 className="text-branding-white font-bold text-lg sm:text-xl mb-2 sm:mb-3">Acquire</h3>
                                    
                                    <p className="text-sm sm:text-base text-branding-white/70">
                                        Identify and purchase underutilized commercial properties suitable for conversion into high-performance AI Innovation and data centers in strategic locations.
                                    </p>
                                </div>
                            </CardContent>
                        </Card>
                        ...
                        <Card className="bg-background/30 border-branding-white/10 backdrop-blur-sm hover:border-branding-orange/30 transition-colors overflow-hidden">
                            <CardContent className="p-4 sm:p-5 md:p-6">
                                <div className="flex flex-col items-center text-center">
                                    ...
                                    <h3 className="text-branding-white font-bold text-lg sm:text-xl mb-2 sm:mb-3">Convert</h3>
                                    
                                    <p className="text-sm sm:text-base text-branding-white/70">
                                        Transform and upgrade properties into state-of-the-art facilities optimized for Innovation and AI and quantum computing. Including infrastructure upgrades to power, cooling systems, fiber connectivity and security enhancements.
                                    </p>
                                </div>
                            </CardContent>
                        </Card>
                        ...
                        <Card className="bg-background/30 border-branding-white/10 backdrop-blur-sm hover:border-branding-orange/30 transition-colors overflow-hidden">
                            <CardContent className="p-4 sm:p-5 md:p-6">
                                <div className="flex flex-col items-center text-center">
                                    ...
                                    <h3 className="text-branding-white font-bold text-lg sm:text-xl mb-2 sm:mb-3">Lease</h3>
                                    
                                    <p className="text-sm sm:text-base text-branding-white/70">
                                        Secure long-term leases with top-tier tech companies including companies we invest in from our portfolio to offer stable cash flow and strong ROI.
                                    </p>
                                </div>
                            </CardContent>
                        </Card>
                        ...
                        <Card className="bg-background/30 border-branding-white/10 backdrop-blur-sm hover:border-branding-orange/30 transition-colors overflow-hidden">
                            <CardContent className="p-4 sm:p-5 md:p-6">
                                <div className="flex flex-col items-center text-center">
                                    ...
                                    <h3 className="text-branding-white font-bold text-lg sm:text-xl mb-2 sm:mb-3">Invest</h3>
                                    
                                    <p className="text-sm sm:text-base text-branding-white/70">
                                        Deploy capital in high-growth AI, quantum, and cloud computing ventures, creating a synergistic ecosystem of portfolio companies and data center tenants.
                                    </p>
                                </div>
                            </CardContent>
                        </Card>
                ...
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                        ...
                        <Card className="bg-background/30 border-branding-white/10 backdrop-blur-sm hover:border-branding-orange/30 transition-colors overflow-hidden">
                            <CardContent className="p-4 sm:p-6 md:p-8">
                                <div className="flex flex-col h-full">
                                    ...
                                    <h3 className="text-2xl sm:text-3xl font-bold text-branding-white mb-2 sm:mb-3">$1 Trillion+</h3>
                                    
                                    <p className="text-sm sm:text-base text-branding-white/70 flex-grow">
                                        Global AI, Quantum & data center market is projected to reach over $1 Trillion USD by 2034, growing at a CAGR of 27.6%.
                                    </p>
                                </div>
                            </CardContent>
                        </Card>
                        ...
                        <Card className="bg-background/30 border-branding-white/10 backdrop-blur-sm hover:border-branding-orange/30 transition-colors overflow-hidden">
                            <CardContent className="p-4 sm:p-6 md:p-8">
                                <div className="flex flex-col h-full">
                                    ...
                                    <h3 className="text-lg sm:text-xl font-bold text-branding-white mb-2 sm:mb-3">AI, IoT, Cloud/Quantum Computing</h3>
                                    
                                    <p className="text-sm sm:text-base text-branding-white/70 flex-grow">
                                        These technologies are fueling the unprecedented demand and surge for new data center infrastructure across global markets.
                                    </p>
                                </div>
                            </CardContent>
                        </Card>
                        ...
                        <Card className="bg-background/30 border-branding-white/10 backdrop-blur-sm hover:border-branding-orange/30 transition-colors overflow-hidden">
                            <CardContent className="p-4 sm:p-6 md:p-8">
                                <div className="flex flex-col h-full">
                                    ...
                                    <h3 className="text-lg sm:text-xl font-bold text-branding-white mb-2 sm:mb-3">Specialized Requirements</h3>
                                    
                                    <p className="text-sm sm:text-base text-branding-white/70 flex-grow">
                                        Surging demand for next-gen applications requires robust, scalable, and secure data centers with specialized cooling and power systems.
                                    </p>
                                </div>
                            </CardContent>
                        </Card>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 md:gap-12">
                        <Card className="bg-background/30 border-branding-white/10 backdrop-blur-sm">
                            <CardContent className="p-4 sm:p-6 md:p-8">
                                <h3 className="text-xl sm:text-2xl font-bold text-branding-white mb-4 sm:mb-6">Data Center Market Projections</h3>
                                
                                <div className="space-y-4 sm:space-y-6">
                                    <div className="flex justify-between items-center">
                                        <span className="text-sm sm:text-base text-branding-white/80">2024 Market Value</span>
                                        <span className="text-xl sm:text-2xl font-bold text-branding-orange">$344B</span>
                                    </div>
                                    ...
                                    <div className="flex justify-between items-center">
                                        <span className="text-sm sm:text-base text-branding-white/80">2034 Projected Value</span>
                                        <span className="text-xl sm:text-2xl font-bold text-branding-orange">$1000B</span>
                                    </div>
                        ...
                        <Card className="bg-background/30 border-branding-white/10 backdrop-blur-sm">
                            <CardContent className="p-4 sm:p-6 md:p-8">
                                <h3 className="text-xl sm:text-2xl font-bold text-branding-white mb-4 sm:mb-6">AI Market Projections</h3>
                                
                                <div className="space-y-6 sm:space-y-8">
                                    <div className="flex flex-col">
                                        <div className="flex justify-between items-center mb-2">
                                            <span className="text-sm sm:text-base text-branding-white/80">Global AI Market 2024</span>
                                            <span className="text-lg sm:text-xl font-bold text-branding-orange">$184B</span>
                                        </div>
                                        <div className="h-2 bg-branding-white/10 rounded-full overflow-hidden">
                                    ...
                                    <div className="flex flex-col">
                                        <div className="flex justify-between items-center mb-2">
                                            <span className="text-sm sm:text-base text-branding-white/80">Projected Value 2030</span>
                                            <span className="text-lg sm:text-xl font-bold text-branding-orange">$1T+</span>
                                        </div>
                                        <div className="h-2 bg-branding-white/10 rounded-full overflow-hidden">
            ...
            <section id="capital" className="py-12 sm:py-16 md:py-24 border-t border-branding-white/10">
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 lg:gap-16 items-center">
                        <div className="space-y-4 sm:space-y-6 md:space-y-8">
                            <Badge className="bg-branding-orange/20 text-branding-orange hover:bg-branding-orange/30 border border-branding-orange/30 px-3 sm:px-4 py-1 sm:py-1.5 text-xs sm:text-sm font-medium tracking-wide uppercase">
                            ...
                            <p className="text-branding-white/80 text-base sm:text-lg md:text-xl">
                                Our strategic approach to capital allocation ensures maximum value creation across real estate assets and technology investments.
                            </p>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 mt-4 sm:mt-8">
                                <div className="relative bg-background/30 border border-branding-white/10 backdrop-blur-sm rounded-xl p-4 sm:p-6 overflow-hidden">
                                    ...
                                    <div className="relative z-10">
                                        ...
                                        <p className="text-xs sm:text-sm text-branding-white/70">
                                            Acquisition and conversion of properties into data centers. Focus on strategic locations with infrastructure advantages.
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div className="relative bg-background/30 border border-branding-white/10 backdrop-blur-sm rounded-xl p-4 sm:p-6 overflow-hidden">
                                    ...
                                    <div className="relative z-10">
                                        ...
                                        <p className="text-xs sm:text-sm text-branding-white/70">
                                            Direct equity investments in AI & quantum ventures with potential for significant growth and synergy with our infrastructure.
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div className="relative bg-background/30 border border-branding-white/10 backdrop-blur-sm rounded-xl p-4 sm:p-6 overflow-hidden">
                                    ...
                                    <div className="relative z-10">
                                        ...
                                        <p className="text-xs sm:text-sm text-branding-white/70">
                                            Operational and overhead costs including team, R&D, marketing, and ongoing improvements to existing facilities.
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="space-y-4 sm:space-y-8 mt-6 lg:mt-0">
                            <Card className="bg-background/30 border-branding-white/10 backdrop-blur-sm">
                                <CardContent className="p-4 sm:p-6 md:p-8">
                                    <h3 className="text-xl sm:text-2xl font-bold text-branding-white mb-4 sm:mb-6">Investment Security</h3>
                                    ...
                                    <div className="space-y-4 sm:space-y-6">
                                        <div className="flex items-start gap-3 sm:gap-4">
                                            ...
                                            <div>
                                                <h4 className="text-base sm:text-lg font-semibold text-branding-white mb-1">Asset Backed Security</h4>
                                                <p className="text-xs sm:text-sm md:text-base text-branding-white/70">Investors receive interest secured by real estate assets worth hundreds of millions.</p>
                                            </div>
                                        </div>
                                        ...
                                        <div className="flex items-start gap-3 sm:gap-4">
                                            ...
                                            <div>
                                                <h4 className="text-base sm:text-lg font-semibold text-branding-white mb-1">Lead Investor Committed</h4>
                                                <p className="text-xs sm:text-sm md:text-base text-branding-white/70">SPUR Capital's own $100 million commitment de-risks the opportunity.</p>
                                            </div>
                                        </div>
                                        ...
                                        <div className="flex items-start gap-3 sm:gap-4">
                                            ...
                                            <div>
                                                <h4 className="text-base sm:text-lg font-semibold text-branding-white mb-1">Structured Debt & Equity</h4>
                                                <p className="text-xs sm:text-sm md:text-base text-branding-white/70">Combination of debt financing secured by assets and equity participation in SPUR Capital's fund.</p>
                                            </div>
                                        </div>
                                    </div>
                                </CardContent>
            ...
            <section id="projections" className="py-12 sm:py-16 md:py-24 border-t border-branding-white/10 bg-gradient-to-b from-background to-background/90">
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                            ...
                            <CardContent className="p-4 sm:p-6 md:p-8">
                                ...
                                <ul className="space-y-3 sm:space-y-4 text-sm sm:text-base text-branding-white/80">
                                    <li className="flex items-start gap-2">
                                        ...
                                        <span>Acquire and convert 2+ new properties</span>
                                    </li>
                                    <li className="flex items-start gap-2">
                                        <div className="rounded-full w-1.5 sm:w-2 h-1.5 sm:h-2 bg-branding-orange mt-[0.4rem] sm:mt-[0.6rem] shrink-0" />
                                        <span>Achieve 95% data center occupancy</span>
                                    </li>
                                    <li className="flex items-start gap-2">
                                        <div className="rounded-full w-1.5 sm:w-2 h-1.5 sm:h-2 bg-branding-orange mt-[0.4rem] sm:mt-[0.6rem] shrink-0" />
                                        <span>Make initial equity investments in AI and Quantum startups</span>
                                    </li>
                                </ul>
                            </CardContent>
                        </Card>
                        ...
                        <Card className="bg-background/30 border-branding-white/10 backdrop-blur-sm hover:border-branding-orange/30 transition-colors">
                            <CardContent className="p-4 sm:p-6 md:p-8">
                                ...
                                <ul className="space-y-3 sm:space-y-4 text-sm sm:text-base text-branding-white/80">
                                    <li className="flex items-start gap-2">
                                        <div className="rounded-full w-1.5 sm:w-2 h-1.5 sm:h-2 bg-branding-orange mt-[0.4rem] sm:mt-[0.6rem] shrink-0" />
                                        <span>Potential partial exits from successful startups</span>
                                    </li>
                                    <li className="flex items-start gap-2">
                                        <div className="rounded-full w-1.5 sm:w-2 h-1.5 sm:h-2 bg-branding-orange mt-[0.4rem] sm:mt-[0.6rem] shrink-0" />
                                        <span>Expand data centers to 100% occupancy</span>
                                    </li>
                                    <li className="flex items-start gap-2">
                                        <div className="rounded-full w-1.5 sm:w-2 h-1.5 sm:h-2 bg-branding-orange mt-[0.4rem] sm:mt-[0.6rem] shrink-0" />
                                        <span>See portfolio value appreciation from real estate and equity stakes</span>
                                    </li>
                                </ul>
                            </CardContent>
                        </Card>
                        ...
                        <Card className="bg-background/30 border-branding-white/10 backdrop-blur-sm hover:border-branding-orange/30 transition-colors sm:col-span-2 md:col-span-1">
                            <CardContent className="p-4 sm:p-6 md:p-8">
                                ...
                                <ul className="space-y-3 sm:space-y-4 text-sm sm:text-base text-branding-white/80">
                                    <li className="flex items-start gap-2">
                                        <div className="rounded-full w-1.5 sm:w-2 h-1.5 sm:h-2 bg-branding-orange mt-[0.4rem] sm:mt-[0.6rem] shrink-0" />
                                        <span>Multiple liquidity events from portfolio companies</span>
                                    </li>
                                    <li className="flex items-start gap-2">
                                        <div className="rounded-full w-1.5 sm:w-2 h-1.5 sm:h-2 bg-branding-orange mt-[0.4rem] sm:mt-[0.6rem] shrink-0" />
                                        <span>Continuous reinvestment to expand global data center footprint</span>
                                    </li>
                                    <li className="flex items-start gap-2">
                                        <div className="rounded-full w-1.5 sm:w-2 h-1.5 sm:h-2 bg-branding-orange mt-[0.4rem] sm:mt-[0.6rem] shrink-0" />
                                        <span>Target 20%+ IRR through blended real estate and venture capital returns</span>
                                    </li>
                                </ul>
                            </CardContent>
                        </Card>
                    ...
                    <div className="mt-8 sm:mt-12 md:mt-16 bg-background/30 border border-branding-white/10 rounded-lg sm:rounded-xl p-4 sm:p-6 md:p-8 max-w-5xl mx-auto">
                        <h3 className="text-xl sm:text-2xl font-bold text-branding-white mb-4 sm:mb-6 text-center">Risk Management</h3>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 md:gap-8">
                            <div className="space-y-4 sm:space-y-6">
                                <div className="flex items-start gap-3 sm:gap-4">
                                    ...
                                    <div>
                                        <h4 className="text-base sm:text-lg font-semibold text-branding-white mb-1">Leasing Risk</h4>
                                        <p className="text-xs sm:text-sm md:text-base text-branding-white/70">Mitigated by focusing on high-demand, specialized data center markets and leveraging relationships with portfolio companies.</p>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-start gap-3 sm:gap-4">
                                    ...
                                    <div>
                                        <h4 className="text-base sm:text-lg font-semibold text-branding-white mb-1">Market Fluctuations</h4>
                                        <p className="text-xs sm:text-sm md:text-base text-branding-white/70">Diversified approach—both real estate and VC investments—reduces vulnerability to a single market's volatility.</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="space-y-4 sm:space-y-6">
                                <div className="flex items-start gap-3 sm:gap-4">
                                    ...
                                    <div>
                                        <h4 className="text-base sm:text-lg font-semibold text-branding-white mb-1">Technology Adoption</h4>
                                        <p className="text-xs sm:text-sm md:text-base text-branding-white/70">Continued growth in AI, quantum and High Performance Computing ensures sustained demand for specialized data center space.</p>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-start gap-3 sm:gap-4">
                                    ...
                                    <div>
                                        <h4 className="text-base sm:text-lg font-semibold text-branding-white mb-1">Regulatory & Environmental</h4>
                                        <p className="text-xs sm:text-sm md:text-base text-branding-white/70">Complying with local zoning, data security, and power regulation. Potential for green energy initiatives to address sustainability concerns.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="relative w-full max-w-5xl mx-auto p-6 sm:p-8 md:p-12 rounded-lg sm:rounded-xl overflow-hidden">
                        ...
                        <div className="relative z-10 text-center space-y-4 sm:space-y-6 md:space-y-8">
                            ...
                            <p className="text-branding-white/80 text-base sm:text-lg md:text-xl max-w-3xl mx-auto">
                                SPUR is focused on building and expanding the most efficient advanced data centers globally. Please contact us for any partnership and investment inquiries.
                            </p>
                            
                            <div className="flex flex-col sm:flex-row gap-4 justify-center pt-2 sm:pt-4">
                                <Button 
                                    className="bg-branding-orange hover:bg-branding-orange/90 text-branding-white group text-sm sm:text-base md:text-lg px-4 sm:px-6 md:px-8 py-3 sm:py-4 md:py-6"
                                >
                                ...
                                <Button 
                                    className="bg-transparent border border-branding-white/20 hover:border-branding-white/40 text-branding-white group text-sm sm:text-base md:text-lg px-4 sm:px-6 md:px-8 py-3 sm:py-4 md:py-6"
                                >
                            ...
                            <div className="pt-4 sm:pt-6 text-branding-white/60 flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-6">
                                <div className="flex items-center gap-2">
                                    ...
                                    <a href="https://www.spuric.com" className="text-sm sm:text-base hover:text-branding-orange transition-colors">www.SPURIC.com</a>
                                </div>
                                
                                <div className="flex items-center gap-2">
                                    <MapPin className="h-4 w-4 sm:h-5 sm:w-5 text-branding-orange/80" />
                                    <span className="text-sm sm:text-base">Waterloo, Ontario, Canada</span>
                                </div>
                                
                                <div className="flex items-center gap-2">
                                    <Server className="h-4 w-4 sm:h-5 sm:w-5 text-branding-orange/80" />
                                    <span className="text-sm sm:text-base">info@spur.com</span>
                                </div>
                            </div>
                        </div>
                    </div>
