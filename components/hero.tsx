                    ...
                    <div className="w-full lg:w-3/5 space-y-6 lg:space-y-8 text-center lg:text-left">
                        ...
                        <div className="space-y-4 sm:space-y-6">
                            ...
                            <p className="text-lg sm:text-3xl md:text-2xl text-branding-white/80 max-w-2xl mx-auto lg:mx-0">
                                Spurring the Future Innovation AI and Quantum Computing Infrastructure
                            </p>
                        </div>
                        ...
                        <div className="grid grid-cols-3 gap-3 sm:gap-6 pt-6 lg:pt-8 border-t border-branding-white/10">
                            <div className="text-center lg:text-left">
                                <p className="text-xl sm:text-2xl lg:text-3xl font-bold text-branding-orange">$500M+</p>
                                <p className="text-sm sm:text-lg text-branding-white/70">Assets Under Management</p>
                            </div>

                            <div className="text-center lg:text-left">
                                <p className="text-xl sm:text-2xl lg:text-3xl font-bold text-branding-orange">100%</p>
                                <p className="text-sm sm:text-lg text-branding-white/70">Data Center Occupancy</p>
                            </div>

                            <div className="text-center lg:text-left">
                                <p className="text-xl sm:text-2xl lg:text-3xl font-bold text-branding-orange">4</p>
                                <p className="text-sm sm:text-lg text-branding-white/70">Operational Centers</p>
                            </div>
                        </div>
                    </div>
